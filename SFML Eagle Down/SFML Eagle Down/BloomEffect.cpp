...
, mSecondPassTextures()
{
	mShaders.load(Shaders::BrightnessPass,   "Shaders/Fullpass.vert"
                  , "Shaders/Brightness.frag");
	mShaders.load(Shaders::DownSamplePass,   "Shaders/Fullpass.vert"
                  , "Shaders/DownSample.frag");
	mShaders.load(Shaders::GaussianBlurPass, "Shaders/Fullpass.vert"
                  , "Shaders/GuassianBlur.frag");
	mShaders.load(Shaders::AddPass,          "Shaders/Fullpass.vert"
                  , "Shaders/Add.frag");
}
