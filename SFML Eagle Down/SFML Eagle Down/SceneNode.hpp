...
class SceneNode : public sf::Transformable, public sf::Drawable, private sf::NonCopyable //derived from
{
	public:
	...
	private:
		...
		SceneNode*				mParent;        //allows us to traverse to find root node
